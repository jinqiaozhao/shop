...
<template>
  <div >
    <div style="margin-bottom:1.24rem;position:relative;">
      <div class="product-select-warp" v-for="(citem,cindex) in thisGetData" style="position:relative;margin-bottom:0.1rem;">
        <!--商户-->
        <div style="width:100%;height:40px;background:#fff;padding:0.1rem 0.2rem;">
          ...
          <section class="check-img com-div-middle-ab" style="position:absolute;top:20px;">
            <input
              type="checkbox"
              name="thisItem" class="item-checkbox" v-model="checkedBussID" :value="citem" >
          ...
          <div style="font-size: 0.25rem;position:absolute;top:15px;left:1.5rem;" v-text="citem.businessName">宝宝余</div>

        </div>
        <!--商品-->
        <div class="all-select-item"  v-if='del'v-for="(citem,cindex) in citem.items">
