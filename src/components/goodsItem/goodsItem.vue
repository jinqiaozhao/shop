<template>
  <div id="box">
    ...
    <div id='goods-type-nav'>
      ...
      <header class="headNav swiper-container" v-show="show">
        <div class="swiper-wrapper">
          ...
          <div class="allItem swiper-slide" style="width:1.25rem;" v-for="(oitem,ind) in nav" :key='ind' @click="getSearchVal(searchnull)" v-if="">
    ...
    <img src="http://orz6nce3e.bkt.clouddn.com/pro_all.jpg" alt="" style="width: 100%;position:relative;top: 2.35rem;" v-if="route==0"/>
    <img src="http://orz6nce3e.bkt.clouddn.com/digital.jpg" alt="" style="width: 100%;position:relative;top:2.35rem;" v-if="route==1"/>
    <img src="http://orz6nce3e.bkt.clouddn.com/foods.jpg" alt="" style="width: 100%;position:relative;top:2.35rem;" v-if="route==2"/>
    <img src="http://orz6nce3e.bkt.clouddn.com/life.jpg" alt="" style="width: 100%;position:relative;top:2.35rem;" v-if="route==3"/>
    <img src="http://orz6nce3e.bkt.clouddn.com/import.jpg" alt="" style="width: 100%;position:relative;top:2.35rem;" v-if="route==4"/>
    <img src="http://orz6nce3e.bkt.clouddn.com/gift.jpg" alt="" style="width: 100%;position:relative;top:2.35rem;" v-if="route==29"/>
    <!--品牌-->
    ...
    <div id="seckill-goods-details">
      <div class="t-product" v-for='item in productData'>
        <div class="t-product-com t-product-img" @click="$router.push('/goodsDetail/'+item.id)">
