<template>
  <div class="eight">
    <div class="banner01"><img src="../../../assets/indexB/banner-world.png"></div>
    <div class="bannerG">
      <div  class="active"@click="searchPro(0,$event)">全部商品</div>
      <div @click="searchPro(1,$event)">休闲零食</div>
      <div @click="searchPro(2,$event)">生活日化</div>
      <div @click="searchPro(3,$event)">粮油调味</div>
    </div>
    <div class="commodity">
