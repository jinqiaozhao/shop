<template>
  <div>
    <div class="banner-img">
      <img src="../../../assets/indexB/banner003.png" alt="">
    </div>
    <div class="banner">
      <div  class="active"@click="searchPro(0,$event)">入耳式</div>
      <div @click="searchPro(1,$event)">便携式</div>
      <div @click="searchPro(2,$event)">蓝牙</div>
      <div @click="searchPro(3,$event)">有线</div>
    </div>
