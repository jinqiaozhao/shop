<template>
  <div class="eight">
    <div class="banner01"><img src="../../../assets/indexB/banner-tea.png"></div>
    <div class="banner">
      <div  class="active"@click="searchPro(0,$event)">保健茶</div>
      <div @click="searchPro(1,$event)">花茶</div>
      <div @click="searchPro(2,$event)">绿茶</div>
    </div>
    <div class="commodity">
