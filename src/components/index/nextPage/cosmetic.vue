<template>
  <div>
    ...
    <div class="banner">
      <div  class="active"@click="searchPro(0,$event)">馋嘴</div>
      <div @click="searchPro(1,$event)">下饭菜</div>
      <div @click="searchPro(2,$event)">辣椒酱</div>
    </div>
    ...
    methods:{
      searchPro(i,e){
        ...
        if(i==0){
          ...
          this.searchVal='老干妈'; this.pageNum='1';this.getData(34,1);
