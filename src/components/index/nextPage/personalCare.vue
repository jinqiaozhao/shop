<template>
  <div>
    <div class="banner-img">
      <img src="../../../assets/indexB/banner-phone.jpg" alt="">
    </div>
    <div class="banner">
      <div  class="active"@click="searchPro(0,$event)">洗发水</div>
      <div @click="searchPro(1,$event)">沐浴露</div>
      <div @click="searchPro(2,$event)">牙膏</div>
      <div @click="searchPro(3,$event)">进口</div>
    </div>
