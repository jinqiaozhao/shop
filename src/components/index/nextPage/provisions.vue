<template>
  <div>
    <div class="banner-img">
      <img src="../../../assets/indexB/banner002.png" alt="">
    </div>
    <div class="banner">
      <div  class="active"@click="searchPro(0,$event)">零嘴</div>
      <div @click="searchPro(1,$event)">糕点</div>
      <div @click="searchPro(2,$event)">禽类</div>
      <div @click="searchPro(3,$event)">肉类</div>
    </div>
