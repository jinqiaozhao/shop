...
<template>
  <div class="index-list">
    <router-link  :class="'list'+oindex" v-for="(oitem,oindex) in nav" :to="oitem.url" tag="div" :key="oindex">
      ...
      <div class="back" v-if='oindex==0'><img src="../../assets/url2.png"></div>
      <div class="back" v-if='oindex==1'><img src="../../assets/url4.png"></div>
      <div class="back" v-if='oindex==2'><img src="../../assets/url1.png"></div>
      <div class="back" v-if='oindex==3'><img src="../../assets/url3.png"></div>
