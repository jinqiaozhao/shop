...
<template>
  <div class="index-list">
    <router-link  :class="'list'+oindex" v-for="(oitem,oindex) in defaultq" :to="oitem.url" tag="div" :key="oindex">
      ...
      <div class="back" v-if='oindex==0'><img src="../../assets/setMal/1.png"></div>
      <div class="back" v-if='oindex==1'><img src="../../assets/setMal/2.png"></div>
      <div class="back" v-if='oindex==2'><img src="../../assets/setMal/3.png"></div>
      <div class="back" v-if='oindex==3'><img src="../../assets/setMal/4.png"></div>
...
//                    {text:'dsd', url:'/today/1/191',name:''},
          {text:'dsd', url:'/today/1/502',name:''},
          {text:'eee', url:'/today/1/504',name:''},
          {text:'yyy', url:'/today/1/505',name:''},
          {text:'iii', url:'/today/1/503',name:''},
        ],
        nav:[],
        sData:sData
